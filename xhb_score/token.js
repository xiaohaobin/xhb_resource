if(window.$ && window.$.cookie){
	console.info($.cookie('assToken'),"assToken")
}
...
! function(e, t) {
			...
			getPath: function() {
				var e = document.currentScript ? document.currentScript.src : function() {
					for (var e, t = document.scripts, i = t.length - 1, n = i; n > 0; n--)
						...
						console.info("e || t[i].src",e || t[i].src)
						return e || t[i].src
				}();
			...
			switch ("string" == typeof t.area && (t.area = "auto" === t.area ? ["", ""] : [t.area, ""]), t.shift &&
				...
				case 2:
					...
					t.content = '<iframe scrolling="' + (t.content[1] || "auto") +
						'" allowtransparency="true"  data-token="123" id="' + l[4] + a + '" name="' + l[4] + a +
	...
	r.prompt = function(e, t) {
		...
		r.open = function(e) {
			...
			var t = new s(e);
			// console.info("run ...open...",i,n,e,t,r)
			return t.index
		}
