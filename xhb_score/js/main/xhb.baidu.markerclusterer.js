...
(function(undefined) {
	...
	(function() {
	    ...
	    ;
	    e.prototype._createClusters = function(fn) {
	    ...
	    ;
	    e.prototype._redraw = function(fn) {
			var j = this;
	        var cc = this._clearLastClusters();
	        this._createClusters();
	    ...
	    g.prototype.addMarker = function(k) {
	        ...
	        if (h < this._minClusterSize) {
	            ...
	            if (h === this._minClusterSize) {
	                for (var n = 0; n < h; n++) {
						var tmplabel = this._markers[n].getLabel();
	                    this._markers[n].getMap() && this._map.removeOverlay(this._markers[n]);
						this._markers[n].setLabel(tmplabel);
	                }
	            }
	        }
	...
	if(typeof module !== "undefined" && module.exports) {
		module.exports = BMapLib;
	} else if(typeof define === "function" && define.amd) {
		define(function() {
			return BMapLib;
		});
	} else {
		!('BMapLib' in _global) && (_global.BMapLib = BMapLib);
	}
}());
