...
(function(undefined) {
	...
	var markerClusterer = function(t) {
	    ...
	    var Ht = q
	      ...
	      , ee = Yt(1..toString)
	      , re = function(t) {
	        return "Symbol(" + (void 0 === t ? "" : t) + ")_" + ee(++Qt + te, 36)
	    }
	      , ne = d
	      , oe = Kt
	      , ie = re
	    ...
	    : function(t, e, r) {
	      ...
	      , pr = {
	        ...
	        .name,
	        CONFIGURABLE: lr && (!sr || sr && fr(cr, "name").configurable)
	    }
	      , hr = tt
	      , mr = Ut
	      , dr = A(Function.toString);
	    hr(mr.inspectSource) || (mr.inspectSource = function(t) {
	        return dr(t)
	    }
	    );
	    var gr, vr, yr, br = mr.inspectSource, wr = tt, kr = d.WeakMap, Sr = wr(kr) && /native code/.test(String(kr)), Or = re, xr = Dt("keys"), Mr = function(t) {
	        return xr[t] || (xr[t] = Or(t))
	    }, Pr = {}, jr = Sr, Er = d, Cr = nt, _r = or, Lr = Kt, Tr = Ut, Ir = Mr, Ar = Pr, Nr = "Object already initialized", zr = Er.TypeError, Dr = Er.WeakMap;
	    if (jr || Tr.state) {
	    ...
	    var Zr = {
	        ...
	        has: yr,
	        enforce: function(t) {
	            return yr(t) ? vr(t) : gr(t, {})
	        },
	        getterFor: function(t) {
	            return function(e) {
	                var r;
	                if (!Cr(e) || (r = vr(e)).type !== t)
	    ...
	    var Ws = d
	      ...
	      , Js = Ue
	      , Ks = function(t) {
	        if ("object" == typeof t || Hs(t))
	            return t;
	        throw Xs("Can't set " + qs(t) + " as a prototype")
	    }
	      , Ys = Object.setPrototypeOf || ("__proto__"in {} ? function() {
	        var t, e = !1, r = {};
	        try {
	            (t = $s(Object.getOwnPropertyDescriptor(Object.prototype, "__proto__").set))(r, []),
	      ...
	      , yu = function(t, e, r) {
	        var n, o;
	        return eu && Qs(n = e.constructor) && n !== r && tu(o = n.prototype) && o !== r.prototype && eu(t, o),
	        t
	    }
	      , bu = ut
	      , wu = xt
	    ...
	    var _u = Cu.prototype
	      ...
	      , Au = function(t) {
	        var e = ku(t, "number");
	        return "bigint" == typeof e ? e : Nu(e)
	    }
	      , Nu = function(t) {
	        var e, r, n, o, i, a, s, u, c = ku(t, "number");
	        if (wu(c))
	            throw Lu("Cannot convert a Symbol value to a number");
	        if ("string" == typeof c && c.length > 2)
	            if (c = ju(c),
	            43 === (e = Iu(c, 0)) || 45 === e) {
	                if (88 === (r = Iu(c, 2)) || 120 === r)
	                    return NaN
	            } else if (48 === e) {
	                switch (Iu(c, 1)) {
	                case 66:
	      ...
	      , Du = function(t) {
	        return bu(_u, t) && Su((function() {
	            Pu(t)
	        }
	        ))
	    }
	      , Ru = function(t) {
	        var e = arguments.length < 1 ? 0 : Cu(Au(t));
	        return Du(this) ? yu(Object(e), this, Ru) : e
	    };
	    Ru.prototype = _u,
	    zu && (_u.constructor = Ru),
	    lu({
	        global: !0,
	        constructor: !0,
	        wrap: !0,
	    ...
	    zu && function(t, e) {
	        for (var r, n = pu ? Ou(e) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,isFinite,isInteger,isNaN,isSafeInteger,parseFloat,parseInt,fromString,range".split(","), o = 0; n.length > o; o++)
	            vu(e, r = n[o]) && !vu(t, r) && Mu(t, r, xu(e, r))
	    }(mu.Number, Cu);
	    ...
	    (Gu = t.MarkerClustererEvents || (t.MarkerClustererEvents = {})).CLUSTERING_BEGIN = "clusteringbegin",
	    Gu.CLUSTERING_END = "clusteringend",
	    Gu.CLUSTER_CLICK = "click";
	    var Bu = function(t, e, r) {
	      ...
	      , Uu = function(r) {
	        ...
	        var i = u(a);
	        function a(t) {
	            var r, n = t.map, o = t.markers, s = void 0 === o ? [] : o, u = t.algorithm, c = void 0 === u ? new Pa({}) : u, l = t.renderer, p = void 0 === l ? new Zu : l, h = t.onClusterClick, m = void 0 === h ? Bu : h;
	            return e(this, a),
	    ...
	    t.Cluster = ki,
	    t.ClusterStats = Fu,
	    t.DefaultRenderer = Zu,
	    t.GridAlgorithm = Wi,
	    t.MarkerClusterer = Uu,
	    t.NoopAlgorithm = Hi,
	    t.SuperClusterAlgorithm = Pa,
	    t.defaultOnClusterClickHandler = Bu,
	...
	if(typeof module !== "undefined" && module.exports) {
		...
		!('markerClusterer' in _global) && (_global.markerClusterer = markerClusterer);
	}
}());
